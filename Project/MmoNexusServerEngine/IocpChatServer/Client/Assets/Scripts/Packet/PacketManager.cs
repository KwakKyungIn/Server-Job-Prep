...
public class PacketManager
{
	...
	public enum MsgId : ushort
	{
		...
		C_CHANNEL_CHANGE_REQ = 1022,
		C_CHAT_REQ = 1023,
		S_CHAT_RES = 1024,
		S_CHAT_NTF = 1025,
		S_HEART_BEAT_RES = 1026,
		C_HEART_BEAT_REQ = 1027,
		C_PARTY_CHAT_REQ = 1028,
		S_PARTY_CHAT_NTF = 1029,
		S_PARTY_INFO_NTF = 1030,
		C_PARTY_CREATE_REQ = 1031,
		C_PARTY_INVITE_REQ = 1032,
		C_PARTY_INVITE_ACCEPT_REQ = 1033,
		C_PARTY_LEAVE_REQ = 1034,
		C_PARTY_KICK_REQ = 1035,
		C_PARTY_DISBAND_REQ = 1036,
		S_PARTY_RESULT = 1037,
		S_PARTY_INVITE_NTF = 1038,
		C_PARTY_STATUS_REQ = 1039,
		S_PARTY_STATUS_NTF = 1040,
		C_DUNGEON_ENTER_REQ = 1041,
