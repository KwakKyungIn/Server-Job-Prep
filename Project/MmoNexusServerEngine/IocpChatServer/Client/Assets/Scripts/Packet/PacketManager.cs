...
public class PacketManager
{
	...
	public enum MsgId : ushort
	{
		...
		S_CHANGE_STAT = 1018,
		S_GOLD_UPDATE = 1019,
		C_MAP_CHANGE_REQ = 1020,
		S_MAP_CHANGE_BEGIN = 1021,
		C_MAP_CHANGE_ACK = 1022,
		S_MAP_CHANGE_END = 1023,
		C_CHANNEL_CHANGE_REQ = 1024,
		C_CHAT_REQ = 1025,
		S_CHAT_RES = 1026,
		S_CHAT_NTF = 1027,
		S_HEART_BEAT_RES = 1028,
		C_HEART_BEAT_REQ = 1029,
		C_PARTY_CHAT_REQ = 1030,
		S_PARTY_CHAT_NTF = 1031,
		S_PARTY_INFO_NTF = 1032,
		C_PARTY_CREATE_REQ = 1033,
		C_PARTY_INVITE_REQ = 1034,
		C_PARTY_INVITE_ACCEPT_REQ = 1035,
		C_PARTY_LEAVE_REQ = 1036,
		C_PARTY_KICK_REQ = 1037,
		C_PARTY_DISBAND_REQ = 1038,
		S_PARTY_RESULT = 1039,
		S_PARTY_INVITE_NTF = 1040,
		C_PARTY_STATUS_REQ = 1041,
		S_PARTY_STATUS_NTF = 1042,
		C_DUNGEON_ENTER_REQ = 1043,
		S_DUNGEON_ENTER_RES = 1044,
		C_DUNGEON_EXIT_REQ = 1045,
		S_DUNGEON_EXIT_RES = 1046,
		S_QUICKSLOT_LIST = 1047,
		C_SET_QUICKSLOT = 1048,
		S_SET_QUICKSLOT = 1049,
		C_TRADE_REQ = 1050,
		S_TRADE_INVITE = 1051,
		C_TRADE_INVITE_RESP = 1052,
		S_TRADE_START = 1053,
		C_TRADE_OFFER_SET = 1054,
		C_TRADE_GOLD_SET = 1055,
		S_TRADE_OFFER_UPDATE = 1056,
		C_TRADE_READY = 1057,
		S_TRADE_READY_STATE = 1058,
		S_TRADE_LOCKED = 1059,
		C_TRADE_CONFIRM = 1060,
		C_TRADE_CANCEL = 1061,
		S_TRADE_CANCELLED = 1062,
		S_TRADE_RESULT = 1063,
		C_INV_DRAG_DROP = 1064,
	}
