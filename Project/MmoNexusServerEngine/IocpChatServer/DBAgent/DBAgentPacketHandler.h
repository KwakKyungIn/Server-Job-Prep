...
public:
    static void Init()
    {
        ...
        GPacketHandler[PKT_S2S_REQ_CHAT_LOG] = [](PacketSessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<Protocol::S2S_REQ_CHAT_LOG>(Handle_S2S_REQ_CHAT_LOG, session, buffer, len); };
    }
    ...
    static SendBufferRef MakeSendBuffer(Protocol::S2S_RES_CHAT_LOG& pkt) { return MakeSendBuffer(pkt, PKT_S2S_RES_CHAT_LOG); }
