...
PROTOBUF_CONSTEXPR BuffData::BuffData(
  ...
  , /*decltype(_impl_.buffid_)*/0u
  , /*decltype(_impl_.remaintime_)*/0u
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\006buffId\030\001 \001(\r\022\022\n\nremainTime\030\002 \001(\r\022\017\n\007vi"
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.buffid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* BuffData::_InternalSerialize(
  ...
  if (this->_internal_remaintime() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(2, this->_internal_remaintime(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.BuffData)
  ...
  // uint32 remainTime = 2;
  if (this->_internal_remaintime() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_remaintime());
  }
