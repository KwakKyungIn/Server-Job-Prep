...
extern C_TEST3DefaultTypeInternal _C_TEST3_default_instance_;
class S_LOGIN;
...
template<> ::Protocol::C_TEST3* Arena::CreateMaybeMessage<::Protocol::C_TEST3>(Arena*);
...
class C_TEST3 final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.C_TEST3) */ {
 public:
  inline C_TEST3() : C_TEST3(nullptr) {}
  ~C_TEST3() override;
  explicit PROTOBUF_CONSTEXPR C_TEST3(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  C_TEST3(const C_TEST3& from);
  C_TEST3(C_TEST3&& from) noexcept
    : C_TEST3() {
    *this = ::std::move(from);
  }

  inline C_TEST3& operator=(const C_TEST3& from) {
    CopyFrom(from);
    return *this;
  }
  inline C_TEST3& operator=(C_TEST3&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const C_TEST3& default_instance() {
    return *internal_default_instance();
  }
  static inline const C_TEST3* internal_default_instance() {
    return reinterpret_cast<const C_TEST3*>(
               &_C_TEST3_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(C_TEST3& a, C_TEST3& b) {
    a.Swap(&b);
  }
  inline void Swap(C_TEST3* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(C_TEST3* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  C_TEST3* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<C_TEST3>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const C_TEST3& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const C_TEST3& from) {
    C_TEST3::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(C_TEST3* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.C_TEST3";
  }
  protected:
  explicit C_TEST3(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.C_TEST3)
 private:
  class _Internal;
...
// uint64 id = 1;
inline void C_TEST3::clear_id() {
  _impl_.id_ = uint64_t{0u};
}
inline uint64_t C_TEST3::_internal_id() const {
  return _impl_.id_;
}
inline uint64_t C_TEST3::id() const {
  // @@protoc_insertion_point(field_get:Protocol.C_TEST3.id)
  return _internal_id();
}
inline void C_TEST3::_internal_set_id(uint64_t value) {
  
  _impl_.id_ = value;
}
inline void C_TEST3::set_id(uint64_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:Protocol.C_TEST3.id)
}
