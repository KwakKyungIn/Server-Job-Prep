...
class BuffData final :
 ...
 public:
  ...
  uint32_t remaintime() const;
  void set_remaintime(uint32_t value);
  private:
  uint32_t _internal_remaintime() const;
  void _internal_set_remaintime(uint32_t value);
  public:
...
inline void BuffData::clear_remaintime() {
  _impl_.remaintime_ = 0u;
}
inline uint32_t BuffData::_internal_remaintime() const {
  return _impl_.remaintime_;
}
inline uint32_t BuffData::remaintime() const {
  // @@protoc_insertion_point(field_get:Protocol.BuffData.remainTime)
  return _internal_remaintime();
}
inline void BuffData::_internal_set_remaintime(uint32_t value) {
  
  _impl_.remaintime_ = value;
}
inline void BuffData::set_remaintime(uint32_t value) {
